...
Object.assign(WEAPONS,{
  ...
  razorhalo:{id:"razorhalo",name:"Razor Halo",icon:"✹",category:"Contracting Ring",damage:10,radius:0,color:"#e9f2f8",haloBlades:8,haloStart:112,haloTime:1.35,haloTurns:1.0,haloDamage:10,
    description:"Impact creates a ring of rotating blades that contracts toward the center while spinning. A tank can be clipped on multiple revolutions if it sits in the shrinking path.",tierNote:"8 blades · 1 turn while contracting · 10 per contact",
  ...
  // V13 Apex Arsenal — 15 original Crater Clash families built around distinct field, utility and spectacle mechanics.
  dicecore:{id:"dicecore",name:"Chaos Die",icon:"⚄",category:"Random Engine",damage:18,radius:28,color:"#ffd76c",diceRolls:4,diceInterval:.22,diceBlast:18,diceShock:14,diceShards:4,dicePush:22,diceJackpot:26,diceCount:1,
    description:"Impact materializes a tumbling energy die. Every roll resolves a different combat face — blast, shock, shards, terrain punch, force pulse or jackpot — so the same aim can unfold differently every time.",tierNote:"1 die · 4 rolls · six possible combat faces",
    tierUpgrades:{2:{name:"Loaded Dice",diceRolls:6,diceInterval:.20,diceBlast:20,diceShock:17,diceShards:5,dicePush:27,diceJackpot:31,diceLoaded:true,visualScale:1.12,tierNote:"6 faster rolls · damage faces are more likely"},3:{name:"Double Down",diceRolls:8,diceInterval:.18,diceBlast:19,diceShock:16,diceShards:5,dicePush:30,diceJackpot:34,diceCount:2,diceSpan:38,diceLoaded:true,visualScale:1.22,tierNote:"2 alternating dice · 8 total rolls · wider coverage"},4:{name:"Casino Singularity",diceRolls:10,diceInterval:.15,diceBlast:20,diceShock:18,diceShards:6,dicePush:34,diceJackpot:38,diceCount:3,diceSpan:54,diceLoaded:true,diceFinal:44,visualScale:1.38,tierNote:"3 dice · 10 rapid rolls · 44-damage jackpot singularity finisher"}}},
  sentryseed:{id:"sentryseed",name:"Sentry Seed",icon:"⌂",category:"Deployable Battery",damage:12,radius:11,color:"#75eaff",sentryCount:1,sentryShots:3,sentryDamage:12,sentryRate:.23,sentrySpan:72,
    description:"The shell plants a miniature autonomous turret on the terrain. It tracks the nearest enemy and fires compact direct rounds from the deployed position instead of simply exploding.",tierNote:"1 turret · 3 tracking shots ×12",
    tierUpgrades:{2:{name:"Twin Turrets",sentryCount:2,sentryShots:3,sentryDamage:11,sentryRate:.21,sentrySpan:96,visualScale:1.12,tierNote:"2 turrets · 3 shots each ×11"},3:{name:"Battery Line",sentryCount:3,sentryShots:4,sentryDamage:9,sentryRate:.18,sentrySpan:132,sentryHeavy:20,visualScale:1.22,tierNote:"3 turrets · 4 shots each ×9 + 20-damage central cannon"},4:{name:"Fortress Protocol",sentryCount:4,sentryShots:4,sentryDamage:9,sentryRate:.15,sentrySpan:168,sentryHeavy:34,sentryBurst:true,visualScale:1.38,tierNote:"4 turrets · 16 tracking shots + 34 heavy core shell + final synchronized burst"}}},
  billiards:{id:"billiards",name:"Break Shot",icon:"⑧",category:"Scatter Bounce",damage:12,radius:15,color:"#f5f5f5",poolBalls:5,poolDamage:12,poolBounces:2,poolSpeed:145,poolHeavy:0,
    description:"Impact racks a set of glowing pool balls and smashes them apart. The balls scatter on different arcs, bounce from terrain, and punish cramped targets from many low-angle directions.",tierNote:"5 balls ×12 · up to 2 terrain bounces",
    tierUpgrades:{2:{name:"Trick Rack",poolBalls:8,poolDamage:10,poolBounces:3,poolSpeed:154,visualScale:1.10,tierNote:"8 balls ×10 · 3 bounces · broader break"},3:{name:"Pool Hall",poolBalls:12,poolDamage:9,poolBounces:3,poolSpeed:166,poolCue:22,visualScale:1.20,tierNote:"12 balls ×9 + 22-damage cue ball"},4:{name:"Rack Attack",poolBalls:15,poolDamage:8,poolBounces:4,poolSpeed:178,poolCue:24,poolHeavy:38,visualScale:1.34,tierNote:"15-ball full rack · 4 bounces + cue ball + 38-damage Eight Ball finisher"}}},
  launchpad:{id:"launchpad",name:"Launch Pad",icon:"⇧",category:"Vertical Displacement",damage:18,radius:22,color:"#ffb35c",launchTargets:1,launchRange:150,launchHeight:88,launchDamage:18,launchSlam:22,launchTime:.72,
    description:"Impact unfolds a booster pad beneath the nearest enemy. The target is lifted high above its terrain position, exposed in the air, then slammed back down when the lift collapses.",tierNote:"1 target · 88px lift · 18 launch + 22 slam damage",
    tierUpgrades:{2:{name:"Booster Pad",launchRange:185,launchHeight:126,launchDamage:20,launchSlam:30,launchTime:.82,visualScale:1.16,tierNote:"126px lift · 20 launch + 30 slam"},3:{name:"Orbital Elevator",launchTargets:2,launchRange:225,launchHeight:168,launchDamage:22,launchSlam:34,launchTime:1.0,launchAirburst:18,visualScale:1.30,tierNote:"Lifts up to 2 targets 168px · 22 launch + 18 airburst + 34 slam"}}},
  chessknight:{id:"chessknight",name:"Knight Shift",icon:"♞",category:"Pattern Strike",damage:15,radius:22,color:"#d6c4ff",knightJumps:4,knightDamage:15,knightStepX:52,knightStepY:34,knightForks:1,
    description:"Impact projects a tactical grid and an energy knight begins making L-shaped jumps across it. Every landing detonates, creating a readable but unusual zig-zag strike pattern.",tierNote:"1 knight · 4 L-jumps ×15",
    tierUpgrades:{2:{name:"Royal Fork",knightJumps:6,knightDamage:14,knightStepX:58,knightStepY:38,knightForks:1,knightFinal:22,visualScale:1.13,tierNote:"6 longer jumps ×14 + 22 check pulse"},3:{name:"Grandmaster",knightJumps:5,knightDamage:13,knightStepX:62,knightStepY:42,knightForks:2,knightFinal:32,visualScale:1.27,tierNote:"2 opposing knights · 10 total landings ×13 + 32 CHECKMATE core"}}},
  cyclone:{id:"cyclone",name:"Cyclone",icon:"◜",category:"Moving Field",damage:8,radius:28,color:"#87f1e3",cycloneCount:1,cycloneTime:1.65,cycloneSpeed:92,cycloneRange:150,cyclonePull:34,cycloneDamage:8,cycloneTick:.28,
    description:"Impact spawns a moving vortex that hugs the terrain, drags nearby tanks toward its core and deals repeated contact damage while sweeping through the target zone.",tierNote:"1 vortex · 150px sweep · repeated 8-damage ticks",
    tierUpgrades:{2:{name:"Supercell",cycloneTime:1.95,cycloneSpeed:105,cycloneRange:190,cyclonePull:46,cycloneDamage:9,cycloneTick:.25,visualScale:1.16,tierNote:"Faster 190px sweep · stronger pull · 9-damage ticks"},3:{name:"Twin Vortex",cycloneCount:2,cycloneTime:2.15,cycloneSpeed:112,cycloneRange:220,cyclonePull:42,cycloneDamage:8,cycloneTick:.23,cycloneFinal:30,visualScale:1.28,tierNote:"2 opposite-moving vortices · 220px each + 30-damage convergence burst"}}},
  rocketcarousel:{id:"rocketcarousel",name:"Rocket Carousel",icon:"◉",category:"Rotating Launcher",damage:12,radius:18,color:"#ff8bd5",carouselRockets:6,carouselDamage:12,carouselRadius:64,carouselTime:1.5,carouselHeavy:0,
    description:"Impact assembles a hovering launch wheel. Rocket pods orbit the hub and fire one-by-one from constantly changing angles, turning a single marker into a rotating crossfire machine.",tierNote:"6 rotating rocket pods ×12",
    tierUpgrades:{2:{name:"Missile Wheel",carouselRockets:8,carouselDamage:12,carouselRadius:72,carouselTime:1.65,visualScale:1.12,tierNote:"8 pods ×12 · wider wheel"},3:{name:"War Carousel",carouselRockets:10,carouselDamage:11,carouselRadius:82,carouselTime:1.8,carouselHeavy:2,carouselHeavyDamage:22,visualScale:1.22,tierNote:"10 rockets ×11 + 2 heavy missiles ×22"},4:{name:"Grand Wheel",carouselRockets:14,carouselDamage:10,carouselRadius:94,carouselTime:2.0,carouselHeavy:4,carouselHeavyDamage:20,carouselFinal:38,visualScale:1.38,tierNote:"14 rockets + 4 heavy missiles + 38-damage collapsing hub"}}},
  kaleidoscope:{id:"kaleidoscope",name:"Bankshot Prism",icon:"◇",category:"Constructed Ricochet",damage:42,radius:0,color:"#83f4ff",mirrorNodes:1,mirrorDamage:42,mirrorSpan:78,mirrorPulses:1,
    description:"Impact constructs a floating reflector at the marker. A beam is then fired from the shooter's position into the reflector and redirected toward an enemy, making marker placement define the shot geometry.",tierNote:"1 reflector · shooter → mirror → target · 42 beam damage",
    tierUpgrades:{2:{name:"Double Bank",mirrorNodes:2,mirrorDamage:30,mirrorSpan:104,mirrorPulses:1,visualScale:1.15,tierNote:"2 reflectors · three-segment bank path · 30 damage per target crossing"},3:{name:"Trick Geometry",mirrorNodes:3,mirrorDamage:27,mirrorSpan:132,mirrorPulses:2,visualScale:1.25,tierNote:"3 moving reflectors · beam traverses the bank twice"},4:{name:"Kaleidoscope",mirrorNodes:5,mirrorDamage:22,mirrorSpan:166,mirrorPulses:2,mirrorDual:true,mirrorFinal:36,visualScale:1.42,tierNote:"5-reflector star geometry · dual counter-beams · 36-damage prism collapse"}}},
  proximitymine:{id:"proximitymine",name:"Proximity Mine",icon:"⌾",category:"Persistent Trap",damage:45,radius:36,color:"#ff6e75",proxMines:1,proxDamage:45,proxSensor:45,proxTurns:3,proxSpan:0,
    description:"Impact plants an armed mine that remains on the battlefield after the shot ends. It detonates only when an enemy moves or begins a turn inside its sensor ring, creating real future-turn area denial.",tierNote:"1 persistent mine · 45 damage · 45px sensor · 3 turns",
    tierUpgrades:{2:{name:"Sensor Net",proxMines:2,proxDamage:36,proxSensor:50,proxTurns:4,proxSpan:76,visualScale:1.12,tierNote:"2 mines ×36 · 50px sensors · survive 4 turns"},3:{name:"Hunter Grid",proxMines:3,proxDamage:32,proxSensor:58,proxTurns:5,proxSpan:120,proxPulse:8,visualScale:1.24,tierNote:"3 mines ×32 · 58px sensors · 5 turns · detection pulse softens nearby targets"}}},
  cryogel:{id:"cryogel",name:"Cryo Gel",icon:"❄",category:"Terrain Status",damage:0,radius:0,color:"#8be8ff",iceSpan:110,iceTurns:3,iceGrip:.72,iceFuel:1.22,iceDamage:0,
    description:"Impact coats a stretch of terrain in slick cryogenic gel that persists across turns. Tanks inside the frozen zone lose climbing grip, slide more easily and spend extra fuel while driving.",tierNote:"110px ice patch · 3 turns · reduced grip + 22% movement fuel cost",
    tierUpgrades:{2:{name:"Ice Sheet",iceSpan:165,iceTurns:4,iceGrip:.60,iceFuel:1.34,iceDamage:8,visualScale:1.15,tierNote:"165px patch · 4 turns · stronger slip + 8 impact damage"},3:{name:"Permafrost",iceSpan:225,iceTurns:5,iceGrip:.48,iceFuel:1.48,iceDamage:12,iceShards:16,visualScale:1.28,tierNote:"225px severe ice zone · 5 turns · 12 impact + crystal-shard burst"}}},
  magnetron:{id:"magnetron",name:"Magnetron",icon:"⊣",category:"Polarity Field",damage:12,radius:0,color:"#ff6d9f",magnetPulses:3,magnetDamage:12,magnetRange:122,magnetForce:38,magnetPoles:2,
    description:"Impact creates alternating red and blue magnetic poles. Every polarity swap pulls and then repels nearby tanks, forcing them to oscillate through the field while taking pulse damage.",tierNote:"2 poles · 3 alternating polarity pulses ×12",
    tierUpgrades:{2:{name:"Flux Engine",magnetPulses:5,magnetDamage:11,magnetRange:150,magnetForce:50,magnetPoles:2,visualScale:1.16,tierNote:"5 polarity swaps ×11 · stronger displacement"},3:{name:"Tri-Polar Reactor",magnetPulses:6,magnetDamage:10,magnetRange:178,magnetForce:46,magnetPoles:3,magnetFinal:28,visualScale:1.30,tierNote:"3-pole vector field · 6 pulses ×10 + 28 reactor discharge"}}},
  emp:{id:"emp",name:"EMP Spike",icon:"⌁",category:"Turn Debuff",damage:12,radius:72,color:"#79a8ff",empDamage:12,empRadius:72,empFuelPenalty:.35,empOverchargeDrain:20,
    description:"The impact emits a system-disruption pulse. Enemies in range take light damage and enter their next turn with reduced movement fuel, making it a tactical setup weapon rather than a pure nuke.",tierNote:"12 damage · next-turn fuel −35% · drains 20 Overcharge",
    tierUpgrades:{2:{name:"Blackout",empDamage:18,empRadius:94,empFuelPenalty:.52,empOverchargeDrain:35,visualScale:1.15,tierNote:"18 damage · next-turn fuel −52% · drains 35 Overcharge"},3:{name:"System Crash",empDamage:24,empRadius:122,empFuelPenalty:.70,empOverchargeDrain:55,empArmorBurn:18,visualScale:1.30,tierNote:"24 damage · next-turn fuel −70% · drains 55 Overcharge + up to 18 armor"}}},
  leech:{id:"leech",name:"Leech Dart",icon:"↝",category:"Drain",damage:32,radius:28,color:"#ff617e",leechDamage:32,leechHeal:.50,leechTargets:1,leechPulses:1,leechRange:78,
    description:"Impact latches an energy tether onto a nearby enemy, drains health through the beam and converts part of the inflicted damage back into health for the firing tank.",tierNote:"1 target · 32 drain damage · heals 50% of applied damage",
    tierUpgrades:{2:{name:"Bloodline",leechDamage:40,leechHeal:.58,leechTargets:1,leechPulses:1,leechRange:98,visualScale:1.14,tierNote:"40 drain · heals 58% · longer latch range"},3:{name:"Vampiric Chain",leechDamage:26,leechHeal:.55,leechTargets:2,leechPulses:2,leechRange:145,visualScale:1.24,tierNote:"2 targets · 2 drain pulses ×26 · shared healing"},4:{name:"Soul Reactor",leechDamage:22,leechHeal:.62,leechTargets:3,leechPulses:3,leechRange:185,leechArmor:true,leechFinal:28,visualScale:1.40,tierNote:"3 targets · 3 pulses ×22 · excess healing becomes armor + 28 reactor collapse"}}},
  tetris:{id:"tetris",name:"Block Drop",icon:"▦",category:"Construct & Clear",damage:13,radius:22,color:"#65e7ff",blockCount:3,blockDamage:13,blockRaise:18,blockSpan:92,blockClear:0,
    description:"Impact opens a digital construction lane. Neon block shapes fall into the area, physically reshape the terrain where they land, and deal contact blasts instead of behaving like ordinary sky bombs.",tierNote:"3 falling blocks ×13 · each builds a small terrain shelf",
    tierUpgrades:{2:{name:"Stack Attack",blockCount:5,blockDamage:12,blockRaise:21,blockSpan:136,blockClear:18,visualScale:1.14,tierNote:"5 blocks ×12 · larger stack + 18 line-clear pulse"},3:{name:"Perfect Clear",blockCount:7,blockDamage:11,blockRaise:24,blockSpan:182,blockClear:34,blockBombs:2,visualScale:1.28,tierNote:"7-shape stack · 2 explosive blocks + 34-damage full line clear"}}},
  eclipse:{id:"eclipse",name:"Eclipse",icon:"◐",category:"Moving Shadow",damage:8,radius:0,color:"#a58cff",eclipsePasses:1,eclipseDamage:8,eclipseWidth:34,eclipseSpan:210,eclipseTime:1.65,eclipseOrbs:1,
    description:"Impact darkens the target zone as an artificial moon crosses overhead. Its narrow moving shadow column damages tanks it passes over, rewarding prediction across horizontal terrain rather than blast placement.",tierNote:"1 moon · 1 shadow sweep · 8 damage per contact tick",
    tierUpgrades:{2:{name:"Totality",eclipsePasses:2,eclipseDamage:8,eclipseWidth:44,eclipseSpan:250,eclipseTime:2.0,eclipseOrbs:1,visualScale:1.14,tierNote:"2 shadow passes · wider 44px totality column"},3:{name:"Binary Eclipse",eclipsePasses:2,eclipseDamage:7,eclipseWidth:42,eclipseSpan:290,eclipseTime:2.15,eclipseOrbs:2,visualScale:1.25,tierNote:"2 counter-moving moons · crossing shadow columns"},4:{name:"Black Sun",eclipsePasses:3,eclipseDamage:7,eclipseWidth:54,eclipseSpan:340,eclipseTime:2.45,eclipseOrbs:2,eclipseFinal:40,visualScale:1.42,tierNote:"2 moons · 3 passes · 54px shadows + 40-damage corona burst"}}}
...
export const WEAPON_TIER_CAPS={
  ...
  molecule:4,
  dicecore:4,sentryseed:4,billiards:4,launchpad:3,chessknight:3,cyclone:3,rocketcarousel:4,kaleidoscope:4,proximitymine:3,cryogel:3,magnetron:3,emp:3,leech:4,tetris:3,eclipse:4,
  waterballoon:3,quicksand:2,dualroller:2,imploder:2,pendulum:3,teslagate:3,satellite:3,wormhole:3,prismcage:3,domino:3,skyhook:3,sandcastle:3,compressor:3,pinball:3,lighthouse:3,repulsor:3,swapbomb:2,phantomcopy:3,meteorsling:3,razorhalo:3,crystalbloom:3,guillotine:3,yoyo:3,
