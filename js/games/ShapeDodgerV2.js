export default {
    manifest: {
        id: 'shape-dodger',
        name: 'Void Dodger V2',
        description: 'Überlebe einen immer härter werdenden Meteor- und Bullet-Hell-Sturm.',
        icon: '🚀',
    ...
    init: (container, services) => {
        ...
        const getWaveName = (type) =>
            waveNames[type] ??
            'UNKNOWN WAVE';


        const getWaveDuration = (type) =>
            waveDurations[type] ??
            5;


        const getWaveBurstInterval = (type) =>
            waveBurstBaseIntervals[type] *
            (
                1 -
                (
                    getWaveIntensity() -
        ...
        const waveSpawners = {
            ...
            zigzagWall:
                spawnZigzagWallBurst,

            seekerPack:
                spawnSeekerPackBurst,

            shooterSquad:
                spawnShooterSquadBurst,

            splitterStorm:
                spawnSplitterStormBurst,
        ...
        const startSpecialWave = () => {
            ...
            specialWave.burstTimer =
                getWaveBurstInterval(
                    type
                );
        };
        ...
        const finishSpecialWave = () => {
            ...
            waveCooldown =
                getCooldownAfterWave();
        };


        const updateWaveDirector = (
            deltaSeconds
        ) => {
            if (!specialWave) {
                waveCooldown -=
